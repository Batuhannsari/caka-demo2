...
export const HeroParallax = ({
    ...
    return (
        <div
            ref={ref}
            className="min-h-screen overflow-hidden antialiased relative flex flex-col items-center [perspective:1000px] [transform-style:preserve-3d]"
        >
            <Header />
            <motion.div
                style={{
            ...
            >
                <motion.div className="flex flex-wrap justify-center space-x-4 mb-16 w-full max-w-6xl mx-auto">
...
export const ProductCard = ({
    ...
    return (
        <motion.div
            ...
            key={product.title}
            className="group/product relative flex-shrink-0 w-[35%] max-w-xs md:max-w-[30%] aspect-w-16 aspect-h-9"
        >
            <Link
                href={product.link}
